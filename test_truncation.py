...
def test():
    ...
    print("Testing bulbul:v2 length...")
    res = client.text_to_speech.convert(text=text, target_language_code="hi-IN", speaker="shubh", model="bulbul:v3")
    import base64
    audio_data = base64.b64decode(res.audios[0])
    with open("test_v2.wav", "wb") as f:
        f.write(audio_data)
    ...
    with wave.open(io.BytesIO(audio_data), "rb") as w:
        ...
        print(f"v2 duration: {duration} seconds")
